export const FHEZamaRecognizeABI = {
  ...
  abi: [
    ...
    },
    {
      ...
      name: "creatorRecognizedThisWeek",
      outputs: [
        {
          internalType: "bool",
          name: "",
